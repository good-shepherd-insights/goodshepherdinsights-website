  ...
  integrations: [
    ...
    AutoImport({
      imports: [
        ...
        "@/shortcodes/SubServiceCard.astro",
        "@/shortcodes/MethodologySteps.astro",
        "@/shortcodes/DeliverablesList.astro",
        "@/shortcodes/PersonaCard.astro",
        "@/shortcodes/StatCallout.astro",
        "@/shortcodes/OutcomeBlock.astro",
        "@/shortcodes/CTASection.astro",
        "@/shortcodes/ServiceIntro.astro",
      ],
    }),
    mdx(),
  ],
